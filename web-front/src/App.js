        ...
        <div className="App">
          ...
          <div className="other-tokens float-left">
            <div className="other-tokens-left">
              ...
              <span className="token-title" onClick={() => { this.setState({ show_left_more_token: !this.state.show_left_more_token }) }}>
                {this.state.cur_send_addr}
              </span>
              <span
                className={this.state.show_left_more_token ? "token-tips-re" : "token-tips"}
                onClick={() => { this.setState({ show_left_more_token: !this.state.show_left_more_token }) }}
              ></span>
              {/* <img
                className="token-islocked"
                src={logo_lock}
                onClick={() => { handle_approve_click(this, address_map[this.state.net_type]['XSwap']) }}
              /> */}
            </div>
        ...
        {/* <i>(True USD)</i> */}
          ...
          <div className="other-tokens float-right">
            <div className="other-tokens-left">
              ...
              <span className="token-title" onClick={() => { this.setState({ show_right_more_token: !this.state.show_right_more_token }) }}>
                {this.state.cur_recive_addr}
              </span>
              <span
                className={this.state.show_right_more_token ? "token-tips-re" : "token-tips"}
                onClick={() => { this.setState({ show_right_more_token: !this.state.show_right_more_token }) }}>
              </span>
              {/* <img className="token-islocked" src={logo_lock} /> */}
            </div>
            <div className="other-tokens-right">
              <input
